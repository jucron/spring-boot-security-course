...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true) //This activates the @PreAuthorize in controllers
...
//                .antMatchers(HttpMethod.DELETE,"/management/api/**").hasAnyAuthority()
